...
from models.iscnet.modules.DGCNN import DGCNN_VOTE
...
class DGCNN_ProposalModule(nn.Module):
    def __init__(self, cfg, optim_spec = None):
        ...
        '''
        super(DGCNN_ProposalModule, self).__init__()
    ...
    def forward(self, xyz, features, end_points, export_proposal_feature=False):
        ...
        # --------- DYNAMIC GRAPH CNN ---------
        dgcnn_features = torch.cat([xyz.transpose(1,2), features], dim=1)
        features = features + self.dgcnn(dgcnn_features)
        # --------- PROPOSAL GENERATION ---------
