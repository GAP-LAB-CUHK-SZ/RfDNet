...
def projmask_cpu(PyViews views, int depth, int height, int width, float vx_size, bool unknown_is_free, int n_threads=1):
...
def occupancy_cpu(PyViews views, int depth, int height, int width, float vx_size, float truncation, bool unknown_is_free, int n_threads=1):
  vol = np.empty((1, depth, height, width), dtype=np.float32)
  cdef float[:,:,:,::1] vol_view = vol
  cdef PyVolume py_vol = PyVolume(vol_view)
...
def tsdfmask_cpu(PyViews views, int depth, int height, int width, float vx_size, float truncation, bool unknown_is_free, int n_threads=1):
  vol = np.empty((1, depth, height, width), dtype=np.float32)
  cdef float[:,:,:,::1] vol_view = vol
  cdef PyVolume py_vol = PyVolume(vol_view)
...
def tsdf_cpu(PyViews views, int depth, int height, int width, float vx_size, float truncation, bool unknown_is_free, int n_threads=1):
  vol = np.empty((1, depth, height, width), dtype=np.float32)
  cdef float[:,:,:,::1] vol_view = vol
  cdef PyVolume py_vol = PyVolume(vol_view)
...
def tsdf_hist_cpu(PyViews views, int depth, int height, int width, float vx_size, float truncation, bool unknown_is_free, float[::1] bins, bool unobserved_is_occupied=True, int n_threads=1):
